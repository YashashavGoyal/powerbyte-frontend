...
export default function Alerts() {
    ...
    return (
        alert &&
        <>
            <div className="absolute top-4 right-4 z-50 w-auto px-4 py-3 text-red-700 bg-red-100 border border-red-400 roundedShadow-lg" role="alert">
                <strong className="font-bold">Error</strong>
                <span className="block sm:inline">: </span>
                <button className="absolute top-0 bottom-0 right-0 px-4 py-3" onClick={handleCloseError}>
