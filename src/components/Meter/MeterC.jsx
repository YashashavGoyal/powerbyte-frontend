            ...
            <div className="p-6 mb-6 bg-white rounded-lg shadow-sm">
                ...
                <div className="flex flex-wrap items-center justify-around gap-6">
                    <div className="flex flex-col items-center">
                        <h5 className="mb-2 font-semibold text-gray-600 text-md">Zone-C Power</h5>
                        <div className="power">
                            <ReactSpeedometer
                                maxValue={1000}
                    ...
                    <div className="flex flex-col items-center">
                        <h5 className="mb-2 font-semibold text-gray-600 text-md">Zone-C Current</h5>
                    ...
                    <div className="flex flex-col items-center">
                        <h5 className="mb-2 font-semibold text-gray-600 text-md">Zone-C Voltage</h5>
